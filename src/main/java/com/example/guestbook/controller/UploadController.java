...
import com.example.guestbook.dao.AttachDAO;
import com.example.guestbook.dao.BoardDAO;
...
public class UploadController {
	...
	@GetMapping("download")
	public String filename(Model model,@RequestParam int num) {
